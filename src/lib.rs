...
pub fn move_num_to_array(num: usize, board_rows: usize) -> [usize; 2] {
...
pub fn create_board(total_rows: usize, total_colums: usize) -> Vec<Vec<char>> {
...
pub fn run_game() {
    ...
    while filled_box_count < MAX_FILL {
        if ai_char == 'X' {
            ...
            // Draw check after AI move
            if filled_box_count == MAX_FILL {
                break;
            }
